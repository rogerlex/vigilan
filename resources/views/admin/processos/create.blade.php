    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.processos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_do_processo') ? 'is-invalid' : '' }}" type="text" name="numero_do_processo" id="numero_do_processo" value="{{ old('numero_do_processo', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('inicio_processo') ? 'is-invalid' : '' }}" type="text" name="inicio_processo" id="inicio_processo" value="{{ old('inicio_processo') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('status_processo') ? 'is-invalid' : '' }}" name="status_processo_id" id="status_processo_id" required>
                    @foreach($status_processos as $id => $status_processo)
                        <option value="{{ $id }}" {{ old('status_processo_id') == $id ? 'selected' : '' }}>{{ $status_processo }}</option>
                    @endforeach
                </select>
