...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.denunciacategorium.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.denunciacategoria.store") }}" enctype="multipart/form-data">
            @csrf
