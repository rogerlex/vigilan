...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tipoProcesso.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tipo-processos.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('descricaotipoprocesso') ? 'is-invalid' : '' }}" type="text" name="descricaotipoprocesso" id="descricaotipoprocesso" value="{{ old('descricaotipoprocesso', '') }}">
